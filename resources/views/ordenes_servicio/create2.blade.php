            ...
            <div class="col-md-6">
                ...
                <div class="card card-outline card-primary card-brand-top shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div id="artefacto-info" class="mt-3" style="display:none;">
                            <hr class="mt-2 mb-2">
                            <div class="row text-sm">
                                <div class="col-6">
                                    <small class="text-muted d-block">Código</small>
                                    <span id="ai-codigo" class="font-weight-medium">—</span>
                                </div>
                                <div class="col-6">
                                    <small class="text-muted d-block">Tipo</small>
                                    <span id="ai-tipo" class="font-weight-medium">—</span>
                                </div>
                            </div>
                            <div class="row text-sm mt-2">
                                <div class="col-6">
                                    <small class="text-muted d-block">Marca</small>
                                    <span id="ai-marca" class="font-weight-medium">—</span>
                                </div>
                                <div class="col-6">
                                    <small class="text-muted d-block">Modelo</small>
                                    <span id="ai-modelo" class="font-weight-medium">—</span>
                                </div>
                            </div>
                            <div class="row text-sm mt-2">
                                <div class="col-12">
                                    <small class="text-muted d-block">Descripción</small>
                                    <span id="ai-descripcion" class="font-weight-medium">—</span>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function () {
    ...
    function actualizarPanelArtefacto() {
        const opt = $('#artefacto_id option:selected');
        if (!opt.val()) { $('#artefacto-info').hide(); return; }
    ...
    $('#artefacto_id').on('change', actualizarPanelArtefacto);
