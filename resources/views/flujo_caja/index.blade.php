            ...
            <div class="card card-outline card-success card-brand-top shadow-sm">
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless mb-0">
                        ...
                        <tr>
                            <td class="text-muted">- Neto Transferencia <small class="text-muted">(no físico)</small></td>
                            <td class="text-right text-danger" id="cierre-neto-transferencia">-${{ number_format($totales['neto_transferencia'], 0, ',', '.') }}</td>
                        </tr>
